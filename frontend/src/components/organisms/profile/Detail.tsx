...
export default function Detail() {
  ...
  const handleSubmit = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    await axios
      .put(`${apiConfig.user.baseUrl}/api/v1/auth/${userData.uuid}`, data, {
        headers: {
  ...
  const getProfile = async () => {
    try {
      const response = await axios.get(
        `${apiConfig.user.baseUrl}/api/v1/auth/user`,
        {
          headers: {
            Authorization: `Bearer ${userData.token}`,
            "x-service-name": serviceName,
              ...
              <div className="card-body">
                <div className={`${styles["account-settings"]}`}>
                  <div className={`${styles["user-profile"]}`}>
                    ...
                    <p className={`${styles["user-name"]} poppins-bold`}>
                      {name}
                    </p>
                  </div>
                  <div className={`${styles["about"]}`}>
                    <h5 className="poppins-bold" style={{ color: "black" }}>
                      About
                    </h5>
                    <p>
                      Selamat datang di profil Anda! Kelola data pribadi, ubah
                      password, dan nikmati kemudahan reservasi lapangan mini
                      soccer di sini.
                    </p>
                  </div>
                </div>
              ...
              <div className="card-body">
                <div className="row gutters">
                  <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <h6 className="mb-2 text-primary poppins-bold">
                      Data Pribadi
                    </h6>
                  </div>
                ...
                <div className="row gutters">
                  <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <h6 className="mt-3 mb-2 text-primary poppins-bold">
                      Ganti Password
                    </h6>
                  </div>
                  <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
