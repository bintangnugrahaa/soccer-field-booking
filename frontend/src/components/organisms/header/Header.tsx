...
export default function Header(props: HeaderProps) {
  ...
  return (
    <>
      <nav
        className="site-nav d-none d-lg-block"
            ...
            <ul className="js-clone-nav d-none d-lg-inline-block text-left site-menu float-right">
              {currentPath === "/" ? (
                <>
                  ...
                  <li>
                    <Link href="#gallery-list">Galeri</Link>
                  </li>
                  <li>
                    <Link href="#field-list">Lapangan</Link>
                  </li>
                </>
              ) : null}
      ...
      <nav className="navbar navbar-expand-lg navbar-light d-lg-none d-sm-block bg-light">
        <Link href="/" className="logo-mobile m-0">
          Star Mini Soccer <span className="text-secondary">.</span>
        </Link>
        <button
          ...
          <ul className="navbar-nav">
            {currentPath === "/" ? (
              <>
                ...
                <li>
                  <Link className="nav-link" href="#facility">
                    Fasilitas
                  </Link>
                </li>
                <li>
                  <Link className="nav-link" href="#gallery-list">
                    Galeri
                  </Link>
                </li>
                <li>
                  <Link className="nav-link" href="#field-list">
                    Lapangan
                  </Link>
                </li>
              </>
            ...
            <li>
              <Link
                href="/"
                title="RegisterForm"
                className="btn btn-login nav-link d-sm-block d-lg-none"
