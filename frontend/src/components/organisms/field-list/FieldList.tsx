          ...
          <div className="row justify-content-center text-center mb-5">
            <div className="col-lg-6">
              ...
              <p className="poppins-regular">
                Temukan berbagai pilihan lapangan mini soccer terbaik dengan
                fasilitas lengkap dan harga terjangkau untuk pengalaman bermain
                yang seru bersama teman-teman Anda.
              </p>
            </div>
          </div>
          <div className="row">
            {fields?.length > 0 ? (
              ...
              <div className="col-12">
                <p className="text-center poppins-bold">
